                        ...
                        <div>
                                    ...
                                    <div class="row border-bottom border-top border-secondary">
                                        <div class="col d-flex justify-content-between mr-3">
                                            <a href="#"><img src="{{asset('storage/img/nostamp.png')}}" alt="item"
                                                             ...
                                                             style="max-width: 50px; max-width: 50px;"></a>
                                            <div class="order-details ml-3">
                                                <div class="cart-table-item px-3 btn"><a href="">{{ $item->name }}</a>
                                                </div>
                                                <div class="cart-table-description"><small
                                                        class="text-muted">{{$item->options->milk}}, Sugar
                                                        - {{$item->options->sugar}}, Syrup
                                                        - {{$item->options->syrup}}</small></div>
                                            </div>
                                            <div class="d-flex align-items-center justifiy-content-between">
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <a class="btn"><small><i class="fas fa-cart-arrow-down"></i></small></a>
                                                    <!--form in laravel-->
                                                </div>
                                                <div class="form-group mt-3">
                                                    <select class="form-control form-select" id="cartQuantity">
                                                        <option selected>{{$item->qty}}</option>
                                                        <option {{ old('quantity') == "1" ? 'selected' : ''}} value="1">
                                                            1
                                                        </option>
                                                        <option {{ old('quantity') == "2" ? 'selected' : ''}} value="2">
                                                            2
                                                        </option>
                                                        <option {{ old('quantity') == "3" ? 'selected' : ''}} value="3">
                                                            3
                                                        </option>
                                                        <option {{ old('quantity') == "4" ? 'selected' : ''}} value="4">
                                                            4
                                                        </option>
                                                        <option {{ old('quantity') == "5" ? 'selected' : ''}} value="5">
                                                            5
                                                        </option>
                                                    </select>
                                                </div>
                            ...
                            <div class="input-group mb-3" style="max-width: 100%;">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="button" id="button-addon2">Apply
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="col cart-totals-right align-items-start">
                                <div>
                                    <span>Subtotal</span> <span
                                        class="float-right">$<?php echo Cart::subtotal(); ?></span><br>
                                    <span>Tax</span> <span class="float-right">$<?php echo Cart::tax(); ?></span><br>
                                    <span>Total</span><span class="float-right">$<?php echo Cart::total(); ?></span>
                                    <br>
                                </div>
                            </div>
                        </div> <!-- end cart-totals -->
